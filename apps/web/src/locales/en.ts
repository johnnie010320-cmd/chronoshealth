...
export const en: Dictionary = {
  ...
  care: {
    ...
    itemMedicalBody: 'Preventive medicine · health screening partners (P2 partial)',
    note: 'This screen becomes active in the R5 slice.',
  ...
  rewards: {
    ...
    spendBody: 'Partner-product discount coupons (active after R5 partner integration)',
    note: 'At P5 mainnet, points are planned to convert 1:1 to $CHRO tokens. This stage is a feature under review.',
  ...
  admin: {
    ...
    dashboard: {
      ...
      actionNoticesDesc: 'Activates in Admin-2',
      actionContent: 'Terms / Disclaimer',
      actionContentDesc: 'Activates in Admin-2',
      actionModeration: 'Community moderation',
      actionModerationDesc: 'Activates in Admin-3',
      actionAffiliates: 'Affiliates',
      actionAffiliatesDesc: 'Activates in Admin-3',
      actionLedgerAdjust: 'Ledger adjustment',
      actionLedgerAdjustDesc: 'Activates in Admin-3',
      actionFeatureRequests: 'Feature requests',
      actionFeatureRequestsDesc: 'Activates in Admin-4',
      actionHealth: 'System health',
      actionHealthDesc: 'Activates in Admin-4',
    },
    users: {
      title: 'User management',
      searchPlaceholder: 'Search pseudonym…',
      columns: {
        pseudonym: 'Pseudonym',
        createdAt: 'Joined',
        reports: 'Reports',
    ...
    disclaimer:
      'All admin actions will be recorded in the audit log (Admin-3). PII unmask is an audited action.',
  },
  routine: {
    pageTitle: 'Routine',
    nav: 'Routine',
