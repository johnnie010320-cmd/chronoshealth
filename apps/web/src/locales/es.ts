...
export const es: Dictionary = {
  ...
  admin: {
    ...
    dashboard: {
      ...
      actionNoticesDesc: 'Se activa en Admin-2',
      actionContent: 'Términos / Aviso',
      actionContentDesc: 'Se activa en Admin-2',
      actionModeration: 'Moderación',
      actionModerationDesc: 'Se activa en Admin-3',
      actionAffiliates: 'Socios',
      actionAffiliatesDesc: 'Se activa en Admin-3',
      actionLedgerAdjust: 'Ajuste de saldo',
      actionLedgerAdjustDesc: 'Se activa en Admin-3',
      actionFeatureRequests: 'Solicitudes',
      actionFeatureRequestsDesc: 'Se activa en Admin-4',
      actionHealth: 'Salud del sistema',
      actionHealthDesc: 'Se activa en Admin-4',
    },
    users: {
    ...
    disclaimer:
      'Todas las acciones del admin se registrarán en el log de auditoría (Admin-3). El unmask de PII es una acción auditada.',
  },
  routine: {
    pageTitle: 'Routine',
    nav: 'Routine',
