...
export const ja: Dictionary = {
  ...
  admin: {
    ...
    dashboard: {
      ...
      actionNotices: 'お知らせ',
      actionNoticesDesc: 'Admin-2 スライスで有効化',
      actionContent: '利用規約 / 免責',
      actionContentDesc: 'Admin-2 スライスで有効化',
      actionModeration: 'モデレーション',
      actionModerationDesc: 'Admin-3 スライスで有効化',
      actionAffiliates: 'パートナー',
      actionAffiliatesDesc: 'Admin-3 スライスで有効化',
      actionLedgerAdjust: '運用調整',
      actionLedgerAdjustDesc: 'Admin-3 スライスで有効化',
      actionFeatureRequests: '機能リクエスト',
      actionFeatureRequestsDesc: 'Admin-4 スライスで有効化',
      actionHealth: 'システムヘルス',
      actionHealthDesc: 'Admin-4 スライスで有効化',
    },
    users: {
      title: 'ユーザー管理',
    ...
    disclaimer:
      '管理者ページの全操作は監査ログ (Admin-3) に記録されます。PII表示は監査対象です。',
  },
  routine: {
    pageTitle: 'Routine',
    nav: 'Routine',
